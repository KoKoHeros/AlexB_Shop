                        ...
                        <nav class="main-menu navbar-expand-md navbar-light">
                            <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    {{--<li class="dropdown">--}}
                                        {{--<a >Admin</a>--}}
                                        {{--<ul class="dropdown-menu" style="padding:0px;margin: auto" aria-labelledby="dropdownMenuLink">--}}
                                            {{--<li class="dropdown-item"><a href="{{url('add_featuredproduct')}}">Add FeaturedProduct</a></li>--}}
                                            {{--<li class="dropdown-item"><a href="{{url('addproduct')}}">Add Product</a></li>--}}
